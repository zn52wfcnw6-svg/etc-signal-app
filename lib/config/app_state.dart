  ...
  void _runMultiDimensionDecision() {
    ...
    if (klines5m.length < 20) {
      ...
      _finalSignal = FinalSignalDecision(
        ...
        resistancePrice: 0,
        currentPrice: _ethPrice,
        trendAnalysis: 'K线数据不足，正在加载中...',
        marketOutlook: '等待K线数据加载完成后进行分析',
        entryAdvice: '等待K线数据加载完成',
        stopLossAdvice: '等待K线数据加载完成',
        takeProfitAdvice: '等待K线数据加载完成',
    ...
    try {
      ...
      _finalSignal = FinalSignalDecision(
        ...
        resistancePrice: 0,
        currentPrice: _ethPrice,
        trendAnalysis: '多维度分析出现异常，正在尝试恢复...',
        marketOutlook: '等待系统恢复正常后重新分析',
        entryAdvice: '等待系统恢复',
        stopLossAdvice: '等待系统恢复',
        takeProfitAdvice: '等待系统恢复',
